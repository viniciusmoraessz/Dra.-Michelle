...
export default function Home() {
  ...
  return (
    <main className="overflow-x-hidden bg-[#fbfdfd] text-[#15355b]">
      ...
      <a href={whatsapp} target="_blank" rel="noreferrer" aria-label="Falar com a Dra. Michelle Ribeiro pelo WhatsApp" className="fixed bottom-5 right-5 z-[60] inline-flex h-14 items-center justify-center gap-2 rounded-full bg-[#25d366] px-4 text-sm font-bold text-white shadow-xl shadow-[#123b67]/30 transition hover:scale-105 hover:bg-[#1fba58] focus:outline-none focus:ring-4 focus:ring-[#25d366]/30 sm:h-15 sm:px-5"><WhatsAppIcon className="h-6 w-6" /><span className="hidden sm:inline">WhatsApp</span></a>
    </main>
  );
}
