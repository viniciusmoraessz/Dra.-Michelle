  ...
  return (
    <main className="overflow-x-hidden bg-[#fbfdfd] text-[#15355b]">
      <header className="fixed inset-x-0 top-0 z-50 border-b border-[#0d72db]/10 bg-white/85 backdrop-blur-xl">
        <div className="mx-auto flex h-[76px] max-w-7xl items-center justify-between px-5 md:px-8">
          <a href="#inicio" className="flex items-center gap-3" aria-label="Início">
            <span className="grid h-10 w-10 place-items-center rounded-full bg-[#0d72db] font-serif text-lg font-bold text-white">MR</span>
          ...
          <a href={instagram} target="_blank" rel="noreferrer" className="hidden rounded-full bg-[#f06c53] px-5 py-3 text-sm font-semibold text-white sm:block">Agendar consulta</a>
      ...
      <section id="inicio" className="relative isolate min-h-[800px] overflow-hidden bg-[#eaf6ff] pt-[76px]">
        ...
        <div className="mx-auto grid max-w-7xl items-center px-5 pb-16 pt-16 md:px-8 lg:min-h-[720px] lg:grid-cols-[.92fr_1.08fr] lg:pt-6">
          <Reveal className="relative z-10 max-w-xl">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row"><a href={instagram} target="_blank" rel="noreferrer" className="inline-flex items-center justify-center gap-2 rounded-full bg-[#f06c53] px-6 py-4 font-bold text-white shadow-lg shadow-[#f06c53]/25"><Instagram size={19} /> Fale no Instagram</a><a href="#localizacao" className="inline-flex items-center justify-center gap-2 rounded-full border border-[#b5d7ef] bg-white px-6 py-4 font-bold text-[#0d72db]"><MapPin size={19} /> Ver localização</a></div>
          </Reveal>
      ...
      <section id="sobre" className="mx-auto grid max-w-7xl gap-12 px-5 py-24 md:px-8 lg:grid-cols-[.92fr_1.08fr] lg:items-center lg:py-32">
        <Reveal className="relative min-h-[380px] overflow-hidden rounded-[2rem] bg-[#0d72db] p-8 text-white sm:min-h-[500px]">
          <span className="absolute inset-x-0 bottom-0 h-2/3 bg-gradient-to-t from-[#0a4f9d] to-transparent" />
          <div className="relative z-10 flex min-h-[315px] flex-col justify-between sm:min-h-[435px]"><span className="grid h-12 w-12 place-items-center rounded-full bg-white/15 text-xl font-serif">MR</span><div><p className="text-3xl font-black leading-none">Dra. Michelle<br />Ribeiro da Silva</p><p className="mt-3 text-sm text-blue-100">Foto profissional a ser adicionada</p></div></div>
          <div className="absolute -right-10 -top-10 h-64 w-64 rounded-full border-[28px] border-[#75c7ff]/25" />
        </Reveal>
