...
export default function Home() {
  ...
  return (
    <main className="overflow-x-hidden bg-[#fbfdfd] text-[#15355b]">
      ...
      <footer className="mt-5 bg-[#123b67] text-white"><div className="mx-auto grid max-w-7xl gap-10 px-5 py-14 md:grid-cols-[1.2fr_.8fr_.8fr] md:px-8"><div className="flex items-start gap-4"><span className="relative h-16 w-16 shrink-0 overflow-hidden rounded-2xl bg-white"><Image src="/logo-mr.png" alt="Monograma MRS" fill className="object-cover" sizes="64px" /></span><div><p className="text-lg font-black">Dra. Michelle Ribeiro da Silva</p><p className="mt-1 text-sm leading-relaxed text-blue-100">Implantodontia e Estética do Sorriso</p></div></div><div><p className="text-xs font-bold uppercase tracking-[.14em] text-[#8ed6ff]">Atendimento</p><a href={whatsapp} target="_blank" rel="noreferrer" className="mt-3 inline-flex items-center gap-2 text-sm font-bold transition hover:text-[#8ed6ff]"><MessageCircle size={17} /> +55 98 97020-5892</a><p className="mt-2 text-sm text-blue-100">Segunda a sexta, com horário agendado</p></div><div><p className="text-xs font-bold uppercase tracking-[.14em] text-[#8ed6ff]">Consultório</p><p className="mt-3 text-sm leading-relaxed text-blue-100">Edifício Tech Office<br />Av. dos Holandeses, 06<br />Ponta D&apos;areia</p></div></div><div className="border-t border-white/15"><div className="mx-auto flex max-w-7xl flex-col gap-3 px-5 py-5 text-xs text-blue-100 sm:flex-row sm:items-center sm:justify-between md:px-8"><p>© 2026 Dra. Michelle Ribeiro. Todos os direitos reservados.</p><a href={instagram} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 font-bold text-white transition hover:text-[#8ed6ff]"><Instagram size={16} /> @dra_michelle.ribeiro</a></div></div></footer>
    </main>
  );
}
